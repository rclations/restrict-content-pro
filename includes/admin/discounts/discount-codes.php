								...
								<div class="row-actions">
									<?php if( current_user_can( 'rcp_manage_discounts' ) ) : ?>
										...
										<?php if(rcp_get_discount_status($code->id) == 'active') { ?>
											<a href="<?php echo esc_url( add_query_arg( array( 'rcp-action' => 'deactivate_discount', 'discount_id' => $code->id ), $page ) ); ?>"><?php _e( 'Deactivate', 'rcp' ); ?></a> |
										<?php } else { ?>
											<a href="<?php echo esc_url( add_query_arg( array( 'rcp-action' => 'activate_discount', 'discount_id' => $code->id ), $page ) ); ?>"><?php _e( 'Activate', 'rcp' ); ?></a> |
										<?php } ?>
										<a href="<?php echo esc_url( add_query_arg( array( 'rcp-action' => 'delete_discount_code', 'discount_id' => $code->id ), $page ) ); ?>" class="rcp_delete_discount"><?php _e( 'Delete', 'rcp' ); ?></a>
									<?php endif; ?>
								</div>
