							...
							<td class="column-primary has-row-actions" data-colname="<?php _e( 'Name', 'rcp' ); ?>">
								...
								<div class="row-actions">
									<?php if( current_user_can( 'rcp_manage_discounts' ) ) : ?>
										...
										<?php } ?>
										<a href="<?php echo esc_url( wp_nonce_url( add_query_arg( array( 'rcp-action' => 'delete_discount_code', 'discount_id' => $code->id ), $page ), 'rcp-delete-discount' ) ); ?>" class="rcp_delete_discount"><?php _e( 'Delete', 'rcp' ); ?></a>
									<?php endif; ?>
								</div>
