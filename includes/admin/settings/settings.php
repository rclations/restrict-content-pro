				...
				<div class="tab_content" id="emails">
					<div id="rcp_email_options">
						...
						<table class="form-table">
							...
							<tr valign="top">
								<th>
									<label for="rcp_settings[send_expiration_reminders]"><?php _e( 'Send Expiration Reminders', 'rcp' ); ?></label>
								</th>
								<td>
									<input type="checkbox" id="rcp_settings[send_expiration_reminders]" name="rcp_settings[send_expiration_reminders]" value="1" <?php checked( true, isset( $rcp_options['send_expiration_reminders'] ) ); ?>/>
									<span><?php _e( 'Check this box if you want customers to receive a reminder when their subscription is about to expire.', 'rcp' ); ?></span>
								</td>
							</tr>
							<tr valign="top">
								<th>
							...
							<tr valign="top">
								<th>
									<label for="rcp_settings[send_renewal_reminders]"><?php _e( 'Send Renewal Reminders', 'rcp' ); ?></label>
								</th>
								<td>
									<input type="checkbox" id="rcp_settings[send_renewal_reminders]" name="rcp_settings[send_renewal_reminders]" value="1" <?php checked( true, isset( $rcp_options['send_renewal_reminders'] ) ); ?>/>
									<span><?php _e( 'Check this box if you want customers to receive a reminder when their subscription is about to renew.', 'rcp' ); ?></span>
								</td>
							</tr>
							<tr valign="top">
								<th>
