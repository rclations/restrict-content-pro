...
<div id="rcp-metabox-field-restrict-by" class="rcp-metabox-field">
	<?php if ( ! empty( $pt_restrictions ) ) : ?>
		<p><?php printf( __( 'This entire post type is restricted. Visit the <a href="%s">post type\'s restriction page</a> to change the settings.', 'rcp' ), esc_url( rcp_get_restrict_post_type_page( get_post_type() ) ) ); ?></p>
	<?php endif; ?>
