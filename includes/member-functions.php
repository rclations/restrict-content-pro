 ...
 *
 * Stripe and Stripe Checkout are omitted from this because their notes are added directly
 * in the gateway to include the event ID.
 * @see RCP_Payment_Gateway_Stripe::process_webhooks()
 *
